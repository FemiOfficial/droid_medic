            ...
            <div class = "row">
				...
				?>
                        <div class = "col-md-3 model-card">
                          <a href = "diagnosis.php?id=<?php echo $row['id'];?>">
                          <?php echo '<img alt = "product-image" class = "img-responsive" src = "data:image/jpeg;base64,'.base64_encode($row["image"]).'">'; ?>       
                            <div class = "model-text"><?php echo $row['model_name']." Phone";?></div>
                          </a>
                        </div>
                <?php
                    }
                ...
                ?>
                        <input type="text" placeholder = "Can't find your brand? Input here....." name="phone-brand" id="phone-brand">
                    </div>
                </div>
            </div>
        </div>
